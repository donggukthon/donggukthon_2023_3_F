		...
		<>
			<Modal open={isOpen} onClose={onClose}>
				<ModalGrid>
					...
					<Grid
						sx={{ display: 'flex', justifyContent: 'center', textAlign: 'center', alignItems: 'center', marginTop: '15px' }}>
						<div style={{ color: 'rgba(0, 0, 0, 0.45)', fontSize: '14px' }}>{acquiredDate}에 취득하신 뱃지입니다!</div>
					</Grid>
					<Box
						sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-around', gap: '10px', padding: '40px 0px' }}>
						<img src={badgeImage} />
